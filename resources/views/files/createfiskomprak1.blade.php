    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="{{ route('files.fisika-komputasi1-praktikum') }}" class="btn btn-md btn-link mb-3">Back</a>

                <div class="card rounded">
                    <div class="card-body">

                        <form action="{{ route('files.storefiskomprak1') }}" method="POST" enctype="multipart/form-data">
                            @csrf
