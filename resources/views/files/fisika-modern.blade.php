                                                ...
                                                @forelse ($files['ebook'] as $file)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="{{ route('files.downloadfismod', $file) }}" class="btn btn-sm btn-primary">Download</a>
                                                        </td>
                                                    </tr>
                                                @empty
                                                    <tr>
                    ...
                    <div class="container mt-5">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card rounded">
                                    <div class="card-body">
                                        <a href="{{ route('files.createfismod') }}" class="btn btn-md btn-primary mb-3 float-end">Upload File</a>
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    <th scope="col">Nama File</th>
