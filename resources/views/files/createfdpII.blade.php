    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="{{ route('files.fisika-dasarII-praktikum') }}" class="btn btn-md btn-link mb-3">Back</a>

                <div class="card rounded">
                    <div class="card-body">

                        <form action="{{ route('files.storefdpII') }}" method="POST" enctype="multipart/form-data">
                            @csrf
